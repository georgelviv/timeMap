<md-content>
  <form name="login" layout="column" layout-fill ng-submit="vm.loginUser(login)" novalidate>
    <md-input-container>
      <label>Username</label>
      <input ng-model="vm.login.username" name="username" minlength="3" required>
    ...
    <md-input-container>
      ...
      <input ng-model="vm.login.password" name="password" type="password" minlength="6" required>
