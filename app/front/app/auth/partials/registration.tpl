<md-content class="md-padding">
  <form layout="column" name="vm.registrationForm" layout-align="center center" layout-fill ng-submit="vm.createUser()">
    <md-input-container>
    ...
    <md-input-container layout-align="center center">
      <div layout="row" layout-sm="column" layout-margin>
        <md-button type="submit" class="md-raised md-primary" flex="50" flex-sm="100">Sign up</md-button>
      </div>
    </md-input-container>
  </form>
</md-content>